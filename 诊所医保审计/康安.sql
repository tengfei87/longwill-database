...
-- where ms_mzxx.zfpb = 0
-- and ms_mzxx.sfrq >= '2018-07-01'
...
-- (select csny from ms_brda where brid = b.brid) '年龄',
...
-- yk_rk02.ypxq '有效期限',
-- yk_rk02.ypph '生产批号',
-- (select pzwh from yk_ypcd where ypxh = yk_rk02.ypxh and ypcd = yk_rk02.ypcd) '批准文号',
-- jhjg / lsjg '成本率'
-- from yk_rk01,yk_rk02
-- where yk_rk01.xtsb = yk_rk02.xtsb
-- and yk_rk01.rkfs = yk_rk02.rkfs
